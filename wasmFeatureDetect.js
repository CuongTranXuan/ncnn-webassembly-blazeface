    ...
    return {
        bigInt: () =>
            (async (e) => {
                try {
                    return (
                        (await WebAssembly.instantiate(e)).instance.exports.b(
                            BigInt(0)
                        ) === BigInt(0)
                    );
                } catch (e) {
        ...
        bulkMemory: async () =>
            WebAssembly.validate(
                new Uint8Array([
                    ...
                    5, 3, 1, 0, 1, 10, 14, 1, 12, 0, 65, 0, 65, 0, 65, 0, 252,
                    10, 0, 0, 11,
                ])
            ),
        exceptions: async () =>
            WebAssembly.validate(
                new Uint8Array([
                    0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0,
                    10, 9, 1, 7, 0, 6, 64, 7, 26, 11, 11,
                ])
            ),
        multiValue: async () =>
            WebAssembly.validate(
                new Uint8Array([
                    0, 97, 115, 109, 1, 0, 0, 0, 1, 6, 1, 96, 0, 2, 127, 127, 3,
                    2, 1, 0, 10, 8, 1, 6, 0, 65, 0, 65, 0, 11,
                ])
            ),
        mutableGlobals: async () =>
            WebAssembly.validate(
                new Uint8Array([
                    0, 97, 115, 109, 1, 0, 0, 0, 2, 8, 1, 1, 97, 1, 98, 3, 127,
                    1, 6, 6, 1, 127, 1, 65, 0, 11, 7, 5, 1, 1, 97, 3, 1,
                ])
            ),
        ...
        saturatedFloatToInt: async () =>
            WebAssembly.validate(
                new Uint8Array([
                    0, 97, 115, 109, 1, 0, 0, 0, 1, 4, 1, 96, 0, 0, 3, 2, 1, 0,
                    10, 12, 1, 10, 0, 67, 0, 0, 0, 0, 252, 0, 26, 11,
                ])
            ),
